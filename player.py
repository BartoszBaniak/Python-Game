...
class Player(object):
    ...
    def draw(self, win):
        ...
        if self.is_alive:
            ...
            if self.health >= 750 and self.health <= 900:
                win.blit(health[0], (1700, 20))
                win.blit(health[0], (1750, 20))
                win.blit(health[0], (1800, 20))

            elif self.health >= 600 and self.health < 750:
                win.blit(health[0], (1700, 20))
                win.blit(health[0], (1750, 20))
                win.blit(health[1], (1800, 20))

            elif self.health >= 450 and self.health < 600:
                win.blit(health[0], (1700, 20))
                win.blit(health[0], (1750, 20))
                win.blit(health[2], (1800, 20))

            elif self.health >= 300 and self.health < 450:
                win.blit(health[0], (1700, 20))
                win.blit(health[1], (1750, 20))
                win.blit(health[2], (1800, 20))

            elif self.health >= 150 and self.health < 300:
                win.blit(health[0], (1700, 20))
                win.blit(health[2], (1750, 20))
                win.blit(health[2], (1800, 20))

            elif self.health > 0 and self.health < 150:
